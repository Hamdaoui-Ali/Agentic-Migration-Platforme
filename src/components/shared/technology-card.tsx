...
export function TechnologyCard({
  ...
  return (
    <Link
      href={href}
      className="mf-focus group flex min-h-[300px] flex-col rounded-2xl border border-[var(--mf-border)] bg-[var(--mf-surface)] p-7 shadow-[var(--mf-shadow)] transition-[transform,border-color,box-shadow] duration-200 hover:-translate-y-0.5 hover:border-[var(--mf-primary)] hover:shadow-[var(--mf-shadow)]"
    >
      <div className="flex items-start justify-between gap-5">
        <div className="grid h-12 w-12 place-items-center rounded-xl border border-[var(--mf-border)] bg-[var(--mf-surface-subtle)] text-[var(--mf-primary)]">
          {icon}
        </div>
